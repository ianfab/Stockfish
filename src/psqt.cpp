...
const Score Bonus[VARIANT_NB][PIECE_TYPE_NB][RANK_NB][int(FILE_NB) / 2] = {
...
#ifdef CRAZYHOUSE
  {
    ...
    { // Rook
      { S(-46,-7), S(-20, 4), S(-11,14), S(-16,-2) },
      { S(-28,-11), S( -8, 3), S( -1,-4), S(-14, 0) },
      { S(-23,-3), S( -2, 4), S(  0, 0), S( 3,-3) },
      { S(-20, 5), S(  0, 0), S(  6, 9), S(-6,-8) },
      { S(-18, 5), S(-18,-19), S( -3,-16), S(-12, 4) },
      { S(-21,-9), S(-11,-14), S( 10,-5), S( 0,11) },
      { S(-14, 3), S( 10,-2), S( 12,-4), S(21, 1) },
      { S(-22,-2), S( -5, 2), S(-11, 7), S(-16,-3) }
    },
    { // Queen
      { S(-9,-71), S( 1,-57), S(-5,-56), S(13,-32) },
      { S(-8,-56), S(15,-32), S(17,-21), S( 0,  6) },
      { S( 9,-48), S(-8,-18), S(11, -8), S(11, -7) },
      { S(-5,-25), S( 0, -4), S(16, 10), S( 4, 18) },
      { S(-3,-21), S(14, -9), S( 0, 14), S(-2, 10) },
      { S(-2,-46), S(14,-12), S(10,-17), S(24,  0) },
      { S(-3,-59), S(-4,-46), S( 3,-16), S(13,-11) },
      { S(-11,-64), S(-23,-52), S(-10,-31), S( 0,-43) }
    },
    { // King
