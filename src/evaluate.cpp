...
#ifdef GRID
    {
      { S(-74,-75), S(-57,-56), S( -9,-29), S( -2,-10), S(  6,  5), S( 15, 12), // Knights
        S( 23, 26), S( 29, 29), S( 36, 29) },
      { S(-53,-56), S(-20,-23), S( 16, -3), S( 27, 13), S( 39, 24), S( 52, 42), // Bishops
        S( 58, 55), S( 63, 59), S( 66, 64), S( 67, 75), S( 80, 78), S( 81, 86),
        S( 93, 84), S(100, 98) },
      { S(-58,-74), S(-29,-17), S(-15, 28), S(-10, 56), S( -5, 71), S( -2, 82), // Rooks
        S(  9,115), S( 15,121), S( 30,140), S( 29,144), S( 32,155), S( 38,166),
        S( 45,167), S( 50,170), S( 58,173) },
      { S(-39,-36), S(-21,-15), S(  3,  8), S(  3, 18), S( 14, 34), S( 22, 54), // Queens
        S( 28, 61), S( 41, 73), S( 43, 79), S( 48, 92), S( 56, 94), S( 60,104),
        S( 60,113), S( 66,120), S( 67,123), S( 70,126), S( 71,133), S( 73,136),
        S( 79,140), S( 88,143), S( 88,148), S( 99,166), S(102,170), S(102,175),
