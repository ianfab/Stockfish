...
#ifdef CRAZYHOUSE
    {
      { S(-115,-118), S( -94,-12), S(-69,-11), S(-26,-18), S(-15, 12), S( -6, 19), // Knights
        S(  19,  60), S(  14, 25), S( 36, 46) },
      { S(-172, -41), S(-121,-20), S( 24,-23), S( 54, 14), S( 54,  8), S( 78, 36), // Bishops
        S( 100,  65), S(  76, 90), S(103, 58), S( 74, 46), S( 74, 85), S( 88,101),
        S(  86,  67), S(  73,109) },
      { S( -53, -60), S( -41,-11), S(-49, 31), S(-22, 41), S(  1, 60), S( 38,104), // Rooks
        S(  38, 116), S(   0,135), S( 51,136), S( 27,184), S( 38,148), S( 28,148),
        S(  19, 145), S(  64,153), S( 65,158) },
      { S( -71,   7), S( -72,-22), S( 31, 37), S( 24, 38), S(  4, 43), S( 27, 48), // Queens
        S(  45,  53), S(  44, 61), S( 35, 75), S( 58, 64), S( 14, 92), S( 58, 80),
        S(  46, 102), S(  58,117), S( 71,116), S( 43,134), S( 87,145), S( 92,139),
        S( 105, 140), S(  72,132), S( 82,142), S( 94,129), S(116,145), S(118,173),
        S( 109, 162), S( 122,196), S(120,199), S(114,174) }
    },
#endif
#ifdef HORDE
    {
