  ...
  const Score MobilityBonus[VARIANT_NB][4][32] = {
...
#ifdef HORDE
    {
      ...
      { S( -46,-2), S(30,66), S( 18, -27), S( 86, 21), S( 65, 11), S(147, 45), // Bishops
        ...
        S( 105, 70), S(131, 82) },
      { S( -55,-78), S(-22,-18), S(-11, 24), S( -5, 58), S( -4, 68), S( -1, 84), // Rooks
        S(   8,108), S( 14,116), S( 21,134), S( 24,136), S( 34,151), S( 30,156),
        S(  43,164), S( 50,162), S( 56,165) },
      { S( -39,-33), S(-24,-13), S(  2,  7), S(  4, 20), S( 14, 38), S( 22, 56), // Queens
        S(  23, 64), S( 43, 66), S( 42, 78), S( 46, 80), S( 53, 92), S( 54,107),
        S(  64,105), S( 65,117), S( 78,111), S( 74,117), S( 78,131), S( 78,134),
        S(  83,139), S( 91,133), S(108,137), S(112,150), S(110,158), S(106,157),
        S( 113,165), S(106,177), S(123,200), S(125,210) }
    },
#endif
#ifdef KOTH
    {
