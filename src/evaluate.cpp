  ...
  const Score MobilityBonus[VARIANT_NB][4][32] = {
...
#ifdef GRID
    {
      ...
      { S(-58,-76), S(-27,-18), S(-15, 28), S(-10, 55), S( -5, 69), S( -2, 82), // Rooks
        S(  9,112), S( 16,118), S( 30,132), S( 29,142), S( 32,155), S( 38,165),
        S( 46,166), S( 48,169), S( 58,171) },
      { S(-41,-35), S(-22,-15), S(  3,  8), S(  3, 17), S( 14, 35), S( 22, 54), // Queens
        S( 27, 63), S( 42, 72), S( 42, 79), S( 48, 88), S( 58, 96), S( 61,108),
        S( 61,110), S( 63,118), S( 66,120), S( 70,129), S( 68,132), S( 72,137),
        S( 81,137), S( 87,147), S( 91,147), S( 97,165), S(100,170), S(104,172),
        S(104,181), S(106,191), S(111,205), S(117,205) }
    },
#endif
#ifdef HORDE
    {
