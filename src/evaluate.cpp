...
#ifdef RACE
    {
      { S(-128,-152), S(-100,-115), S( -9,-67), S(  7,-29), S( 11,-24), S( 29, 16), // Knights
        S(  34,  51), S(  54,  70), S( 90, 92) },
      { S(-116,-125), S( -25, -36), S( 28,-12), S( 33, 17), S( 79, 46), S( 94, 58), // Bishops
        S( 106, 113), S( 145, 124), S(133,122), S(158,149), S(157,148), S(154,180),
        S( 167, 187), S( 210, 188) },
      { S(-109,-162), S( -77, -42), S(-21, 31), S(-10, 95), S( -9,136), S(-17,141), // Rooks
        S(   7, 208), S(  27, 241), S( 35,275), S( 67,293), S( 71,320), S( 69,314),
        S(  80, 356), S( 117, 326), S( 99,336) },
      { S( -72, -62), S( -48, -17), S( 15, -7), S( 19, 21), S(  9, 87), S( 34,103), // Queens
        S(  43, 134), S(  91, 144), S( 87,148), S( 97,158), S(106,208), S(121,191),
        S( 124, 231), S( 160, 220), S(164,238), S(149,252), S(166,267), S(164,268),
        S( 161, 263), S( 193, 274), S(182,256), S(186,312), S(225,321), S(234,318),
        S( 241, 349), S( 231, 355), S(243,391), S(265,384) }
    },
#endif
#ifdef RELAY
    {
