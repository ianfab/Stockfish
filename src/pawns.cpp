...
namespace {
  ...
  TUNE(Isolated[CRAZYHOUSE_VARIANT], Backward[CRAZYHOUSE_VARIANT],
       Unsupported[CRAZYHOUSE_VARIANT], Doubled[CRAZYHOUSE_VARIANT]);
...
TUNE(Seed[CRAZYHOUSE_VARIANT], init);
