...
namespace {
  ...
  TUNE(razor_margin[CRAZYHOUSE_VARIANT], futility_margin_factor[CRAZYHOUSE_VARIANT],
       futility_margin_parent[CRAZYHOUSE_VARIANT], probcut_margin[CRAZYHOUSE_VARIANT]);
